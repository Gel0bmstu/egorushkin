...
plot(t,Z(1,:),'k-',t,XA(1,:),'b-',t,XA2(1,:),'r-',t,Xkd(1,:),'y-',t,X(1,:),'m-')
grid on;
legend(['Z'],['XA'],['XA2'],['Xkd'],['X'],'FontSize',8);
figure('Name','Ошибка по углу','NumberTitle','off');
plot(t,XA(2,:),'b-',t,XA2(2,:),'r-',t,Xkd(2,:),'y-',t,X(2,:),'m-')
grid on;
legend(['XA'],['XA2'],['Xkd'],['X'],'FontSize',8);
figure('Name','Дрейф','NumberTitle','on');
plot(t,XA(3,:),'b-',t,XA2(3,:),'r-',t,Xkd(3,:),'y-',t,X(3,:),'m-')
legend(['XA'],['XA2'],['Xkd'],['X'],'FontSize',8);
grid on;
% figure('Name','Ошибка по скорости','NumberTitle','off');
