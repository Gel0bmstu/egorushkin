...
legend(['X'],['XA'],['XA2'],'FontSize',8);
% 
% %раскомментируй, если нужен Калман
% figure('Name','Дрейф','NumberTitle','on');
...
% figure('Name','TAR ОґVe РёР·РјРµСЂРµРЅРёРµ СЃРєРѕСЂРѕСЃС‚Рё','NumberTitle','off');
% plot(t,TAR_d(1,:));
% grid on;
% 
% figure('Name','TAR Р¤n РёР·РјРµСЂРµРЅРёРµ СЃРєРѕСЂРѕСЃС‚Рё','NumberTitle','off');
% plot(t,TAR_d(2,:));
% grid on;
% 
% figure('Name','TAR П‰РґСЂ РёР·РјРµСЂРµРЅРёРµ СЃРєРѕСЂРѕСЃС‚Рё','NumberTitle','off');
% plot(t,TAR_d(3,:));
% grid on;
